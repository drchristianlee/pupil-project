...
for curMovie = 1:count;
    ...
    for z = 1:frames;
      contrastkeeper(:,:,z) = imadjust(I(:,:,z), [0.0 0.1], []); %originally 0.06, also used at 0.04, for recent movies set to 0.1 to start
    end
...
save('diamKeeper.mat', 'diamKeeper');
