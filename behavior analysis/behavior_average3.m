...
Goskeepername = char(strcat(subname, 'Goskeeper.mat'));
save(Goskeepername, 'Goskeeper');
NoGoskeepername = char(strcat(subname, 'NoGoskeeper.mat'));
save(NoGoskeepername, 'NoGoskeeper');
Misseskeepername = char(strcat(subname, 'Misseskeeper.mat'));
save(Misseskeepername, 'Misseskeeper');
FAskeepername = char(strcat(subname, 'FAskeeper.mat'));
